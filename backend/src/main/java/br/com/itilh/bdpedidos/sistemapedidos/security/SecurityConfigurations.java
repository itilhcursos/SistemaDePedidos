...
import br.com.itilh.bdpedidos.sistemapedidos.controller.AuthenticationController;
...
public class SecurityConfigurations {
    ...
    @Bean
    public AuthenticationManager authenticationManager (AuthenticationController authenticationConfiguration) throws Exception{
