...
public class FormaPagamentoController {
    ...
    public FormaPagamento criarFormaPagamento(@RequestBody FormaPagamento entity) throws Exception {
        try {
            if(entity.getId() != null){
                throw new Exception("Já existe uma Forma de Pagamento com este ID.");
            }
            return repositorio.save(entity);
        } catch (Exception e) {
            throw new Exception("Erro ao adicionar a Forma de Pagamento.");
        }
    }
    ...
    public FormaPagamento alterarFormaPagamento(@PathVariable BigInteger id, @RequestBody FormaPagamento novosDados) throws Exception {
        ...
        throw new Exception ("Não foi possível alterar esta Forma de Pagamento.");
    }
    ...
    public String deletePorId(@PathVariable BigInteger id) throws Exception{
        ...
        throw new Exception ("ID da Forma de Pagamento não foi encontrado, falha na exclusão.");
    }
}
