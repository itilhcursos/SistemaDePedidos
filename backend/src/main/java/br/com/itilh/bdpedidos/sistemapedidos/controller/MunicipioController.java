...
public class MunicipioController {
    ...
    public List<Municipio> getMunicipios() {
        return (List<Municipio>)service.listarMunicipios();
    }
    ...
    public List<Municipio> getMunicipiosPorEstadoNome(@PathVariable String nome) {
        return (List<Municipio>)service.listarMunicipiosPorEstadoNome(nome);
    }
    ...
    public Municipio postMunicipio(Municipio entity) throws Exception {    
