...
ItemPedidoService itemPedidoService;
 ...
 @GetMapping("/item-pedidos")
    public Page<ItemPedidoDTO> getItemPedidos(
     ...
     @GetMapping("/item-pedidos/pedido-id/{id}")
    public Page<ItemPedidoDTO> buscarItemPedidosPorPedidoId(@PathVariable BigInteger id,
        ...
        Pageable pageable = PageRequest.of(pageNumber - 1, pageSize, Sort.Direction.valueOf(direction), property);
        return itemPedidoService.listarItemPedidosPorPedidoId(id, pageable);
    }

    @GetMapping("/item-pedidos/produto-nome/{nome}")
    public Page<ItemPedidoDTO> getItemPedidosPorProdutoNome(@PathVariable String nome,
        @RequestParam(required = false, defaultValue = "1") int pageNumber,
        @RequestParam(required = false, defaultValue = "10") int pageSize,
        @RequestParam(required = false, defaultValue = "ASC") String direction,
        @RequestParam(required = false, defaultValue = "id") String property
