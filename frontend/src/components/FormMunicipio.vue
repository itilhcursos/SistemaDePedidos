  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="text" v-model="nome" placeholder="Nome do Município"/>
      </div>
      ...
      <div class="mb-3 d-flex justify-content-end">
        <button class="btn btn-primary m-2" type="submit" @:click.prevent="salvarMunicipio">
