        ...
        <tr v-for="produto in listaProdutos" :key="produto.id" scope="row">
          ...
          <td class="d-flex justify-content-end">
            ...
            <button
              ...
              @click="excluirEstado(produto.id)"
            >
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-auto">
          <select v-model="property" class="form-select">
            ...
            <option value="nome">Quantidade no estoque</option>
            <option value="nome">Preço atual</option>
            <option value="nome">Confirmação de compra</option>
          </select>
        </div>
        <div class="col-auto">
...
<script>
import FormProdutos from "./FormProdutos.vue";
