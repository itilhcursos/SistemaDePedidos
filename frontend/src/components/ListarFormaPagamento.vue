    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-2 d-flex justify-content-end">
                <button v-if="!formVisible" @click="novoFormaPagamento" class="btn btn-success"><i class="bi bi-clipboard-plus"></i>Novo</button>
            </div>
            <div class="row">
                <div>
                    <FormFormaPagamento
                        v-if="formVisible"
                        v-bind:propsFormaPagamento="formaPagamentoEscolhido"
                        @cancelar="limpar"
    ...
    <div v-if="!formVisible">
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-auto">
                    <button v-for="pagina in totalPages" :key="pagina" @click.prevent="irPara(pagina)" class="btn btn-light me-1">
                        {{ pagina }}
                    </button>
                </div>
                <div class="col-auto"><input type="text" v-model="pageNumber" placeholder="Número da pagina" class="form-control w-25"/>
                </div>
                <div class="col-auto">
...
export default {
    ...
    methods: {
        async buscarFormaPagamentos() {
            this.formaPagamentoEscolhido = null;
            this.formVisible = false;
            //buscar a lista de Formas de Pagamento no servidor
            // http://localhost:8080/formasPagamento
            const response = await axios.get(
                `http://localhost:8080/formasPagamento?pageNumber=${this.pageNumber}&pageSize=${this.pageSize}&direction=${this.direction}&property=${this.property}`
            );
