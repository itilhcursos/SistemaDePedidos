<template>
  <div class="container">
    <div class="row">
      ...
      <div class="row">
        <div>
          <FormProduto v-if="formVisible" :propsProduto="produtoEscolhido" @cancelar="limpar" @salvar_produto="buscarProduto"/>
        </div>
      </div>
    </div>
  ...
  <div v-if="!formVisible">
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-auto">
          <button @click.prevent="buscarProduto" class="btn btn-success"><i class="bi bi-binoculars"></i> Buscar</button>
        </div>
      </div>
    </div>
  </div>
