      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-auto">
          <select v-model="property" class="form-select">
            ...
            <option value="quantidade no estoque">Quantidade no estoque</option>
            <option value="preço atual">Preço atual</option>
            <option value="confirmacao de compra">Confirmação de compra</option>
          </select>
        </div>
        <div class="col-auto">
