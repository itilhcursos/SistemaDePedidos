<template>
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div>
                    <FormItemPedido v-if="formVisible" :propsItemPedido="itemPedidoEscolhido" @cancelar="limpar"
            ...
            <tbody>
                <tr v-for="itemPedido in listaItemPedido" :key="itemPedido.id" scope="row">
                    ...
                    <td class="d-flex justify-content-end">
                        <button class="btn btn-btn btn-primary m-2" @click="alterarItemPedido(itemPedido)">
                            <i class="bi bi-clipboard-pulse"></i> Alterar
                        </button>

                        <button class="btn btn-outline-danger m-2" @click="excluirItemPedido(itemPedido.id)">
