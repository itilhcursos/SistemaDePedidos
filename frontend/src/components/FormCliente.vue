  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="text" v-model="cnpj" placeholder="cnpj cliente" />
      </div>

      <div class="mb-3">
        <label class="form-label">CPF</label>
        <input class="form-control" type="text" v-model="cpf" placeholder="Insira o Cpf" />
      </div>

      <div class="mb-3">
        <label class="form-label">TELEFONE</label>
        <input class="form-control" type="text" v-model="telefone" placeholder="Insira o Telefone" />
      </div>

      <div class="mb-3">
        <label class="form-label">ENDEREÇO</label>
        <input class="form-control" type="text" v-model="endereco" placeholder="Insira o Endereço" />
      </div>

      <div class="mb-3">
        <label class="form-label">BAIRRO</label>
        <input class="form-control" type="text" v-model="bairro" placeholder="Insira o Bairro" />
      </div>

      <div class="mb-3">
        <label class="form-label">CEP</label>
        <input class="form-control" type="text" v-model="cep" placeholder="Insira o Cep" />
      </div>

      <div class="mb-3">
        <label class="form-label">EMAIL</label>
        <input class="form-control" type="text" v-model="email" placeholder="Insira o Email" />
      </div>

      <div class="mb-3">
        <label class="form-label">INFORMAÇÕES</label>
        <input class="form-control" type="text" v-model="informacao" placeholder="Insira as Informações" />
      </div>
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="text" v-model="municipioId"
    ...
    async salvarCliente() {
      ...
      try {
        ...
        if (error.response.status === 403) {
          this.mensagem = "Usuário não identificado. Faça seu login!!!";
