    ...
    <div class="container">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="number" v-model="quantidadeEstoque"
                    placeholder="Quantidade em Estoque" />
            </div>
            <div class="mb-3">
                <label class="form-label">Preço Unitário</label>
                <input class="form-control" type="number" v-model="precoUnidadeAtual" placeholder="Preço Unitário" />
            </div>
            <div class="mb-3">
