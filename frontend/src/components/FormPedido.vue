<template>
  ...
  <script>
  import clienteService from "@/components/FormPedido.vue";
  import produtoService from "@/components/FormPedido.vue";
  import itemPedidoService from "@/components/FormPedido.vue";
  import formaPagamentoService from "@/components/FormPedido.vue";
  export default {
    props: {
      propsPedido: Object,
    },
