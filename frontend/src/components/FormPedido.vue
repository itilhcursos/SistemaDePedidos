  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="mb-3">
        ...
        <v-select class="meu-select" v-model="selectedCliente" :filterable="false" :options="optionsCliente" :reduce="option => option.id">
          <template v-slot:no-options> Não encontrado.</template>
        ...
        <table class="table table-dark table-striped">
              ...
              <tbody>
                <tr v-for="item in itens" :key="item.id" scope="row">
                  <th><img :src=item.produtoUrlImagem height="50px"></th>
                  ...
                  <th>
                    <button class="btn btn-outline-danger m-2" @click.prevent="excluirItemPedido(item.id)"><i class="bi bi-clipboard2-minus"></i></button>
                  </th>
                </tr>
              </tbody>
        </table>
      ...
      <div class="row">
        ...
        <div class="col-2 position-relative">
          <button class="btn btn-primary position-absolute top-50 start-50 translate-middle" type="submit" @click.prevent="incluirItem"><i class="bi bi-clipboard2-check"></i> Incluir</button>
        </div>
      </div>
      ...
      <div class="mb-3 d-flex justify-content-end">
        <button class="btn btn-primary m-2" type="submit" v-on:click.prevent="salvar"><i class="bi bi-clipboard2-check"></i>{{ getAcao }}</button>
