<template>
  <div class="container">
    ...
    <form>
      <div class="row">
        <div v-if="id !== ''" class="col md-2 mb-3">
        ...
        <div class="row">
          ...
          <v-select class="meu-select" v-model="selectedCliente" :filterable="false" :options="optionsCliente" @search="onSearchCliente">
            <template v-slot:no-options> Não encontrado.</template>
      ...
      <div class="row align-items-end">
        ...
        <div class="col-2 mb-5 position-relative">
