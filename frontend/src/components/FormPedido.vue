...
export default {
  ...
  methods: {
    ...
    async salvarPedido() {
      ...
      // if (this.selectedCliente.id === "" || this.selectedCliente.id === null) {
      //   this.isInvalido = true;
    ...
    async incluirItem() {
      if (this.id === "") {
        this.isInvalido = true;
        this.mensagem =
          "É necessáro criar o pedido primeiro para adicionar os itens!";
        return;
      }
      ...
      if (this.id && (!this.selectedProduto || !this.selectedProduto.id)) {
        this.isInvalido = true;
        this.mensagem =
          "É necessáro informar um produto para incluir ao pedido";
        return;
      }
  ...
  computed: {
    getAcao() {
      return this.id === "" ? "Incluir Pedido" : "Alterar Pedido";
    },
  },
};
</script>
