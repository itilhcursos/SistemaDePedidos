        ...
        <form>
                ...
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                        <tr v-for="item in itens" :key="item.id" scope="row">
                            ...
                            <th class="text-center align-middle">{{ formatarPreco(item.quantidadeEstoque *
            ...
            <div class="row align-items-end">
                <div class="col-8">
                    ...
                    <v-select class="meu-select" v-model="selectedProduto" :filterable="false" :options="optionsProduto"
                        ...
                        <template v-slot:option="option">
                            ...
                            {{ option.descricao }} Qtd({{ option.quantidadeEstoque }}) - Preço({{
                                option.precoUnidadeAtual }})
                        </template>
                        <template v-slot:selected-option="option">
                            <img class="mini" :src='option.urlImagem' />
                            {{ option.descricao }} -Qtd({{ option.quantidadeEstoque }}) - Preço({{
                ...
                <div class="col-2">
                    ...
                    <button class="btn btn-primary w-100" type="submit" v-on:click.prevent="incluirItem">
